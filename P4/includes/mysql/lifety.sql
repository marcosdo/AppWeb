...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-04-2022 a las 10:32:21
...
(1, 2, 'Hombro', 'Elevacion lateral', 'Tomando aire elevamos las mancuernas hasta que los brazos queden alineados con los hombros y desde allÃ­ bajamos lentamente mientras exhalamos. Las elevaciones laterales se pueden hacer con ambas manos juntas o tambiÃ©n, alternando un brazo y otro.', '1'),
(2, 0, 'Hombro', 'Press hombro', 'Las mancuernas deben quedar a la altura de los hombros y las palmas de las manos cerradas mirando hacia delante. Activando los mÃºsculos de los brazos y los hombros, levanta lentamente el peso por encima de tu cabeza, haciendo una forma triangular que termine con ambas pesas juntas encima de la cabeza.', '2'),
(3, 1, 'Hombro', 'Remo al menton', 'Primero colÃ³cate de pie y sujeta la barra con ambas manos. Es importante que las manos estÃ©n, como mÃ­nimo, separadas a una anchura igual a la del torso. La espalda debe estar totalmente recta y los brazos, estirados. Coge aire antes de comenzar el ejercicio. En segundo lugar, levanta la barra de forma continua y sin parar, hasta que alcances el mentÃ³n. Esta debe mantenerse muy cerca del cuerpo. MantÃ©n la posiciÃ³n unos segundos. Finalmente, baja de forma lenta y continua, para comenzar el ciclo de nuevo.', '3'),
(4, 0, 'Hombro', 'Press militar', 'Cogemos la barra con las manos en pronaciÃ³n (con las palmas mirando hacia adelante). Las manos deben situarse a una anchura algo superior a la de los hombros. Sacamos la barra de su soporte y la colocamos sobre la parte alta de nuestro pecho, a la altura de nuestras clavÃ­culas.', '4'),
(5, 0, 'Pierna', 'Sentadilla', 'Abre tus piernas hasta el ancho de tus hombros. Junta tus manos o estira tus brazos en un Ã¡ngulo de 90 grados. Cuando vayas a bajar, mantÃ©n los glÃºteos hacia atrÃ¡s. Haz como si fueras a sentarte en una silla imaginaria. A continuaciÃ³n repite el ejercicio.', '5'),
(6, 0, 'Pierna', 'Prensa', 'Para colocarse: sentarse en la prensa inclinada de piernas y situando un pie en el centro de la plataforma. Hay que mantener el pie recto o un poco girado hacia fuera. No apoyes la cabeza en el respaldo. MantÃ©n una posiciÃ³n neutra con los ojos mirando la plataforma. Ten el pecho elevado y la zona lumbar bien apoyada. Sobre el movimiento: libera el peso de los topes de seguridad. Dobla la pierna para bajar la plataforma hasta que la rodilla casi toque el pecho. No permitÃ¡is que la cadera se eleve para aumentar el recorrido. Parar durante un segundo y estira la pierna empujando el peso, pero detente justo antes de bloquear la rodilla. RepÃ­telo.', '6'),
(7, 1, 'Pierna', 'Extension de cuadriceps', 'SiÃ©ntate en una silla y apoya los pies en el suelo separados el ancho de las caderas. MantÃ©n la espalda recta. Extiende la rodilla izquierda hacia delante y contrae los mÃºsculos del cuÃ¡driceps. Vuelve a la posiciÃ³n inicial y repite las veces indicadas. Repite el mismo proceso con la pierna derecha.', '7'),
(8, 1, 'Pierna', 'Hip thrust', 'Empuja con los talones. AsegÃºrate que las espinillas estÃ©n verticales en la parte mÃ¡s alta del movimiento. MantÃ©n las rodillas hacia afuera. Logra una extensiÃ³n completa de cadera. Ligeramente inclina posteriormente la pelvis. MantÃ©n las costillas abajo.MantÃ©n la vista al frente. Haz puÃ±o tus manos y entierra los brazos en la banca. Respira hondo y contrae el core antes de cada levantamiento. Haz una pausa en el tope y aprieta los glÃºteos. ', '8'),
(9, 0, 'Pecho', 'Press banca', 'TÃºmbate en un banco plano y echa los hombros hacia atrÃ¡s. La lÃ­nea extendida desde los hombros hasta las vÃ©rtebras lumbares debe estar apoyada en el banco. La cabeza estarÃ¡ apoyada sobre el banco, mientras que las piernas formarÃ¡n un Ã¡ngulo de 90Âº en el suelo. Lleva la barra a la altura de los hombros, con las muÃ±ecas rectas y las manos rodeando firmemente la barra. Realiza el movimiento, tomando aire al mismo tiempo que contraes glÃºteos, espalda y omÃ³platos fijos. Al respirar profundamente aliviarÃ¡s la presiÃ³n de la columna y estabilizar la parte central del cuerpo. Coloca la barra sobre el pecho de forma lenta y controlada. ElÃ©vala con un movimiento contundente.', '9'),
(10, 2, 'Pecho', 'Aperturas con mancuernas', 'Para comenzar el ejercicio debemos tumbarnos de espalda sobre un banco plano y estrecho para que durante el movimiento no nos moleste en los hombros. Con mancuernas en ambas manos cuyas palmas deben mirar hacia el centro del cuerpo y manteniendo los brazos levemente flexionados en vertical al cuerpo, sobre el pecho, inspiramos y separamos los brazos del cuerpo hasta llegar a la altura de los hombros y que los codos pasen mÃ¡s abajo que estos, es decir, mantenemos los brazos alineados entre sÃ­, perpendicular al cuerpo y paralelos al suelo.', '10'),
(11, 0, 'Pecho', 'Press banca inclinado', 'SiÃ©ntate en el banco y lleva las mancuernas a los lados del pecho. Empuja las mancuernas hacia el techo, pero sin bloquear completamente los codos. A continuaciÃ³n, baja las mancuernas de forma lenta y controlada de nuevo hacia el pecho. Haz una pausa de 1-2 segundos en la parte baja del ejercicio y, sin perder la tensiÃ³n en los brazos, repite el mismo proceso las veces indicadas.', '11'),
(12, 1, 'Pecho', 'Maquina de empuje', 'Ajusta la altura del asiento para que los agarres queden a la altura de los hombros o un poco por debajo. SiÃ©ntate erguido con la espalda contra el acolchado y coloca los pies sobre el suelo directamente bajo las rodillas y separados aproximadamente a la anchura de los hombros. Sujeta los agarres con las palmas mirando hacia fuera. Toma aire y aguanta la respiraciÃ³n mientras empujas para llevar los agarres lejos del cuerpo. Expulsa el aire despuÃ©s de pasar la parte mÃ¡s difÃ­cil del movimiento o cuando los brazos estÃ©n completamente extendidos. Haz una pequeÃ±a pausa y regresa a la posiciÃ³n inicial. Cuando las manos se aproximen a la altura del pecho, cambia rÃ¡pidamente la direcciÃ³n del movimiento y repite.', '12'),
(13, 0, 'Triceps', 'Fondos', 'Los fondos pueden hacerse en barras paralelas de modo que se trabaja de forma intensa el pectoral y el trÃ­ceps colocando los brazos estirados a la anchura de los hombros y elevando y descendiendo el cuerpo en vertical hasta hacer un Ã¡ngulo de 90 grados con el codo.', '13'),
(14, 1, 'Triceps', 'Press frances', 'Nos colocamos en un banco plano y cogemos la barra con un agarre prono. Ponemos los antebrazos flexionados y los brazos en vertical. Cogemos el aire y efectuamos una tensiÃ³n de los codos, llegando la barra hasta la frente, pero sin llegar a tocarla. En la vieja escuela, este ejercicio era conocido como el Â«rompefrentesÂ». Conforme estÃ©s bajando la barra a la frente, evita separar los codos, porque perderÃ¡s reclutamiento de fibras del trÃ­ceps. CÃ©ntrate en juntar ambos codos a la cabeza.', '14'),
(15, 2, 'Triceps', 'Extensiones', 'Para comenzar este ejercicio debemos posicionarnos de pie frente al aparato de polea alta, y habiendo seleccionado el peso a utilizar, debemos tomar con las manos el mago de manera que las palmas miren hacia el suelo. Con los brazos pegados al torso y los codos siempre alineados con el cuerpo, comenzamos el movimiento. Realizamos una extensiÃ³n de los codos, llevando el mango de la polea hacia abajo, sin despegar los codos de los lados del cuerpo y Ãºnicamente movilizando el antebrazo. Espiramos al final del movimiento y regresamos lentamente a la posiciÃ³n inicial.', '15'),
(16, 1, 'Triceps', 'Barras paralelas', 'Es muy importante cuidar la ejecuciÃ³n de cada ejercicio, vigilando la postura y protegiendo la espalda, intentando mantenerla siempre recta. Con una mano en cada barra, nos elevamos con los brazos firmes y estirados, nos inclinamos ligeramente hacia delante y comenzamos con la bajada hasta que nuestros brazos formen un Ã¡ngulo de 90Âº aproximadamente. Mantenemos la posiciÃ³n un segundo y subimos de forma explosiva hasta la posiciÃ³n inicial.', '16'),
(17, 2, 'Biceps', 'Curl spider', 'Te apoyas contra un banco inclinado de forma inversa. Coge la mancuerna en supinaciÃ³n (palmas hacia delante), empezar por hacer el curl spider en el brazo derecho, llevando la mancuerna hasta el bÃ­ceps  hasta que estÃ© totalmente contraÃ­do. DespuÃ©s de tener el bÃ­ceps derecho contraÃ­do, bajar lentamente hasta que tu brazo derecho estÃ© completamente extendido. A medida que baja el bÃ­ceps derecho, iniciar el mismo movimiento con el bÃ­ceps izquierdo alternando de esta forma cada brazo.', '17'),
(18, 1, 'Biceps', 'Predicador', 'Coge con ambas manos la barra que se une al cable de la polea. Realiza un movimiento de curl acercando la barra hacia los hombros, sujeta la polea en esta posiciÃ³n durante unos segundos, y lentamente comienza a extender los brazos hasta que estos vuelvan a su posiciÃ³n inicial y repite.', '18'),
(19, 1, 'Biceps', 'Martillo', 'ColÃ³cate de pie, con las rodillas ligeramente flexionadas y coge una mancuerna en cada mano, de tal manera que las palmas se miren entre ellas. AsÃ­, el peso se descarga sobre las piernas y no sobre la columna vertebral. MantÃ©n la espalda recta durante el desarrollo de todo el ejercicio. Los brazos deben estar extendidos a lo largo de los costados, debemos tratar de no movilizar el brazo y codo, Ãºnicamente el antebrazo. Inhalamos y procedemos a realizar una flexiÃ³n de codo con uno de los brazos y asÃ­ de forma alterna, manteniendo la posiciÃ³n de los brazos. ', '19'),
(20, 1, 'Biceps', 'Chin-ups', 'Coloca las manos sobre la barra, alineadas con los hombros (o a un poco menos distancia), con las palmas hacia adentro, es decir, con un agarre en supinaciÃ³n. Con los brazos extendidos, aprieta los omÃ³platos ligeramente, echando los hombros hacia atrÃ¡s. Imagina que intentas exprimir una naranja grande entre los hombros. Intenta tensar los mÃºsculos abdominales, o llevar el ombligo hacia dentro hacia la columna vertebral. Esto te ayudarÃ¡ a activar el nÃºcleo y mejorar el equilibrio. Tira del torso hacia arriba con los bÃ­ceps y aprieta los omÃ³platos. Yo me visualizo usando los brazos/bÃ­ceps cuando estoy abajo y los mÃºsculos de la espalda cuando estoy casi en la parte de arriba del movimiento. Pausa un momento cuando estÃ©s arriba y lentamente, y con control, baja a la posiciÃ³n inicial. La fase de descenso debe durar entre 2 y 3 segundos y debes evitar bloquear completamente los codos al extender los brazos.', '20'),
(21, 0, 'Espalda', 'Jalon', 'Primero, asegÃºrate de que la barra larga estÃ¡ bien enganchada a la mÃ¡quina. Ajusta el rodillo a la medida adecuada para bloquear tus piernas. Sujeta la barra con las palmas de las manos mirando hacia delante (agarre en pronaciÃ³n) y con una separaciÃ³n de mÃ¡s del ancho de los hombros. InclÃ­nate ligeramente hacia atrÃ¡s (unos 20Âº aproximadamente), saca pecho y contrae el abdomen. Tira de la barra hacia la parte superior del pecho mientras aprietas los omÃ³platos. Los codos deben moverse hacia abajo y no hacia atrÃ¡s. De forma lenta y controlada, lleva la barra a la posiciÃ³n inicial estirando completamente los brazos y estirando los dorsales. Repite el proceso las veces indicadas.', '21'),
(22, 0, 'Espalda', 'Remo en T', 'ColÃ³cate de pie frente a la mÃ¡quina de barra en T con las rodillas ligeramente flexionadas. Tu espalda debe mantener en una postura recta. Ajusta la altura de la mÃ¡quina, para que puedas recostar tu pecho en una inclinaciÃ³n de 45Â° sobre la almohadilla del banco de la mÃ¡quina. Tome la barra con firmeza y posiciÃ³nela frente a usted con los brazos extendidos. Inhale y jale la barra hasta que llegue al pecho. Exhale una vez finalizado el movimiento. Vuelva a la posiciÃ³n inicial de forma suave.', '22'),
(23, 1, 'Espalda', 'Remo con barra', 'Mirada al frente (ligeramente al suelo), toda tu columna debe estar alineada. Movimiento de retracciÃ³n escapular, e iniciamos el tirÃ³n de los codos, junto a la ejecuciÃ³n de una leve disociaciÃ³n lumbopÃ©lvica (esto evita el aumento de tensiÃ³n en las lumbares). Las muÃ±ecas deben permanecer en la misma posiciÃ³n durante todo el movimiento, rectas, bloqueadas. Al tiempo que se flexionan los brazos los codos van hacia afuera y terminan el movimiento en la posiciÃ³n mÃ¡s alta de nuestro cuerpo. Nos daremos cuenta que para terminar de ejecutar el remo con barra correctamente, en la posiciÃ³n alta, las escÃ¡pulas tienden a tocarse.', '23'),
(24, 1, 'Espalda', 'Remo mancuernas banco', 'Necesita colocar un banco inclinado a 30Âº para hacer el ejercicio. Seleccione el peso adecuado de las mancuernas. Coja las pesas, siÃ©ntese en el banco y descanse el pecho sobre la almohadilla. Su cabeza debe estar mÃ¡s alta que el banco. Los pies deben estar en el suelo y los brazos deben estar rectos. Retrayendo los omÃ³platos, levante las mancuernas hacia los lados de su pecho mientras exhala. Mientras hace el ejercicio, mueva solo el brazo, asegÃºrese de no mover ninguna otra parte de su cuerpo. Vuelva a la posiciÃ³n inicial con un suave movimiento mientras inhala.', '24');
...
--
ALTER TABLE `foro`
  MODIFY `id_foro` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT de la tabla `mensaje`
--
ALTER TABLE `mensaje`
  MODIFY `id_mensaje` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT de la tabla `noticias`
--
ALTER TABLE `noticias`
  MODIFY `id_noticia` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
